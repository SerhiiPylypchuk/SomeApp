...
import com.spylypchuk.someapp.android.presentation.ui.mapper.getDrawableRes
    ...
    state.weatherInfo?.currentWeatherData?.let { data ->
        Card(
            ...
            Column(
                ...
                Text(
                    text = "Today ${data.time.toFormattedString("(DD.MM) HH:mm")}",
                    modifier = Modifier.align(Alignment.End),
                    color = Color.White
                )
                Spacer(modifier = Modifier.height(16.dp))
                Image(
                    painter = painterResource(id = data.weatherType.getDrawableRes()),
